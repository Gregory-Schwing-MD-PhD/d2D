/* 
 * compile with
 *  gcc  helix_pred.c -lm -O9 -Wall -Wextra -ansi -pedantic -o helix.x
 */
...
int do_test(char *inputfile)
{
  ...
  for(ashift=0;ashift<NSHIFT;ashift++) {
    switch(ashift)
    {
      case CA: strcpy(n1,"/helix-db/CA-uno.dat"); strcpy(n2,"/helix-db/CA-due.dat"); strcpy(n3,"/helix-db/CA-tre.dat"); 
               strcpy(n4,"/helix-db/CA-quattro.dat"); strcpy(n5,"/helix-db/CA-parm.dat"); break;
      case CB: strcpy(n1,"/helix-db/CB-uno.dat"); strcpy(n2,"/helix-db/CB-due.dat"); strcpy(n3,"/helix-db/CB-tre.dat"); 
               strcpy(n4,"/helix-db/CB-quattro.dat"); strcpy(n5,"/helix-db/CB-parm.dat"); break;
      case CO: strcpy(n1,"/helix-db/CO-uno.dat"); strcpy(n2,"/helix-db/CO-due.dat"); strcpy(n3,"/helix-db/CO-tre.dat"); 
               strcpy(n4,"/helix-db/CO-quattro.dat"); strcpy(n5,"/helix-db/CO-parm.dat"); break;
      case HN: strcpy(n1,"/helix-db/HN-uno.dat"); strcpy(n2,"/helix-db/HN-due.dat"); strcpy(n3,"/helix-db/HN-tre.dat"); 
               strcpy(n4,"/helix-db/HN-quattro.dat"); strcpy(n5,"/helix-db/HN-parm.dat"); break;
      case HA: strcpy(n1,"/helix-db/HA-uno.dat"); strcpy(n2,"/helix-db/HA-due.dat"); strcpy(n3,"/helix-db/HA-tre.dat"); 
               strcpy(n4,"/helix-db/HA-quattro.dat"); strcpy(n5,"/helix-db/HA-parm.dat"); break;
      case NH: strcpy(n1,"/helix-db/NH-uno.dat"); strcpy(n2,"/helix-db/NH-due.dat"); strcpy(n3,"/helix-db/NH-tre.dat"); 
               strcpy(n4,"/helix-db/NH-quattro.dat"); strcpy(n5,"/helix-db/NH-parm.dat"); break;
    }
